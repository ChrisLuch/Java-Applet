...
public class NumFieldTest extends JFrame implements ActionListener
{
    ...
    NumberField numField1;
    
    public NumFieldTest() {
        super("Number Field Test");
        final JPanel comp = new JPanel();
        this.numField = new NumberField();
        this.numField1 = new NumberField("35.5e3");
        ...
        comp.add(this.b1);
        comp.add(this.numField);
        comp.add(this.numField1);
        comp.add(this.b2);
        comp.add(this.b3);
        comp.add(this.b4);
        comp.add(this.b5);
    ...
    public static void main(final String[] array) {
        final NumFieldTest numFieldTest = new NumFieldTest();
        numFieldTest.setSize(300, 300);
        numFieldTest.show();
    }
}
